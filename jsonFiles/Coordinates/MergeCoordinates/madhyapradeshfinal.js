const googleGujrat = require("../madhyacoordinates.json");
const Gujrat = require("../../madhyapradesh.json");
const fs = require("fs");
...
function get() {
  ...
  fs.writeFile(
    ...
    (error) => {
      if (error) {
        console.log(error);
      } else console.log(`File written madhya final`);
    }
  );
}

exports.madhyafinal = get;
