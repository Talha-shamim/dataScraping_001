...
async function get() {
  await axios
    .get("https://covid19dashboard.py.gov.in/BedAvailabilityDetails")
    .then((res) => {
      ...
      $("#Vaccination_KKL > div > table > tbody > tr > td.text-left").each(
        (i, dt) => {
      ...
      $(
        "#Vaccination_MAH > div > table > tbody > tr.text-right > td.text-left"
      ).each((i, dt) => {
        var tg = $(dt).text().substring(53);
        var newtg = tg.trim();
        name.push(newtg);
      ...
      $(
        "#Vaccination_YAN > div > table > tbody > tr.text-right > td.text-left"
      ).each((i, dt) => {
        var tg = $(dt).text().substring(53);
        var newtg = tg.trim();
        name.push(newtg);
      ...
      $("#Vaccination_KKL > div > table > tbody > tr > td:nth-child(5)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          totalo2bed.push(newtg);
      ...
      $("#Vaccination_MAH > div > table > tbody > tr > td:nth-child(5)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          totalo2bed.push(newtg);
      ...
      $("#Vaccination_YAN > div > table > tbody > tr > td:nth-child(5)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          totalo2bed.push(newtg);
      ...
      $("#Vaccination_PDY > div > table > tbody > tr > td:nth-child(6)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
      ...
      $("#Vaccination_KKL > div > table > tbody > tr > td:nth-child(6)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          availableo2bed.push(newtg);
      ...
      $("#Vaccination_MAH > div > table > tbody > tr > td:nth-child(6)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          availableo2bed.push(newtg);
      ...
      $("#Vaccination_YAN > div > table > tbody > tr > td:nth-child(6)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          availableo2bed.push(newtg);
      ...
      $("#Vaccination_PDY > div > table > tbody > tr > td:nth-child(2)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
      ...
      $("#Vaccination_KKL > div > table > tbody > tr > td:nth-child(2)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          date.push(newtg.substring(0, 10));
      ...
      $("#Vaccination_MAH > div > table > tbody > tr > td:nth-child(2)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          date.push(newtg.substring(0, 10));
      ...
      $("#Vaccination_YAN > div > table > tbody > tr > td:nth-child(2)").each(
        (i, dt) => {
          var tg = $(dt).text();
          var newtg = tg.trim();
          date.push(newtg.substring(0, 10));
